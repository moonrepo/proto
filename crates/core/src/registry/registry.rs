    ...
    pub async fn load_internal_plugins(&mut self) -> miette::Result<Vec<&PluginEntry>> {
        if self.internal.is_empty() {
            ...
            let plugins = self.load_plugins_from_registry(
                ...
                "https://raw.githubusercontent.com/moonrepo/proto/develop-0.36/registry/data/built-in.json".into(),
            ).await?;
    ...
    pub async fn load_external_plugins(&mut self) -> miette::Result<Vec<&PluginEntry>> {
        if self.external.is_empty() {
            ...
            let plugins = self.load_plugins_from_registry(
                ...
                "https://raw.githubusercontent.com/moonrepo/proto/develop-0.36/registry/data/third-party.json".into(),
            ).await?;
